...
# sbatch  --mem=32000 --gres=gpu:k40m:3 --cpus-per-task=5 -t 20:00:00 --job-name=road --output='./logs/test_cs %j' --wrap="python massachussets_noisy_students.py -enc timm-efficientnet-l2"